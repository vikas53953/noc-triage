...
| 5 | Build (wave process, worklaw) | IN PROGRESS — CW-1…CW-11 merged (see HANDOFF); **CW-12 Live Presence MERGED 2026-09-05 (PR #78, 3 review rounds → APPROVE)**. Earlier note kept for history: **CW-1 MERGED + LIVE-VERIFIED 2026-08-17** (PRs #42+#43, 2 review rounds; desk at /desk.html, capabilities honest, 428 name gate, audit every state change). Next: CW-2 change engine + drift. CW-2 pre-work: fix guardrails verb-presence-in-rationale class; add compound "read then change" honest refusal; hide raw name beside scrubbed. | docs/copilot-cw1-contract.md |
