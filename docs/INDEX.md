...
| [`copilot-cw14-runtime-contract.md`](copilot-cw14-runtime-contract.md) | Stop hand-rolling the agent loop: the runtime pick (OpenAI Agents SDK + provider adapter), the 12/12 spike, what must survive, stages A–D. | **Current — stage A delivered** (PR #81, 2026-09-05); stages B–D next. |
